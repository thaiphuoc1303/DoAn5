...
public class PostManagementAdapter extends  RecyclerView.Adapter<PostManagementAdapter.PostAdapterHolder>{
    Context context;
    ...
    public PostAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.post_management_layout, parent, false);
    ...
    public class PostAdapterHolder extends RecyclerView.ViewHolder{
        ImageButton btnLike, btnLiked, btnShare, btnComment, btnMore;
        ImageView imgview;
        LinearLayout layoutMore;
        TextView tvName, tvStatus, tvTime, tvCount, tvDelete, tvEditPost;
        int sttMore = 0;
        public PostAdapterHolder(@NonNull View view) {
            ...
            tvEditPost = view.findViewById(R.id.tvEditPhoto);
